...
const TOOL_NAME = "editFile";

const TOOL_DESCRIPTION = `Partially replace file content. Safer than writeFile because it requires an exact match of the original content.`;
