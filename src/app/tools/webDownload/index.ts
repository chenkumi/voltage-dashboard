...
const TOOL_NAME = "webDownload";

const TOOL_DESCRIPTION = `Download a file from a specified URL to the root/downloads virtual directory. Useful for saving reports, images, or raw data.`;
